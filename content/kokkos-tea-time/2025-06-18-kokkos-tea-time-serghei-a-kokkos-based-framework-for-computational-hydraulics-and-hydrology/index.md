...
summary: 'On June the 18th, Daniel Caviedes-Voullieme from the Jülich Supercomputing Centre will give a talk entitled "SERGHEI: a Kokkos-based framework for computational hydraulics and hydrology"'
date: 2025-05-18
links:
- icon_pack: fab
  name: 'Watch on Youtube'
  icon: youtube
  url: https://youtu.be/scI8jB2e5UQ?si=cPs_f3BTQcg-asCf
  cta_new_tab: true
#- icon_pack: fas
#  name: 'Get the slides'
#  icon: file-pdf
...
CExA organizes the 12th **Kokkos tea-time** on Wednesday, June the 18th, 2025 for 45min starting at [7AM Pacific, 10AM Eastern, 4PM Paris, 11PM Tokyo](https://www.worldtimebuddy.com/?qm=1&lid=8,5,2988507,1850147&h=8&date=2025-06-18&sln=7-8).
