...
#        icon: github    
  - block: markdown
    content:
      text: |
        MDFT is a software package for classical and molecular density functional theory calculations, enabling the computation of salvation free energies of complex solutes in solution for a fraction of the price of fully atomistic simulations while keeping data on the solvent structure. Currently MDFT enable solvation in water, supercritical CO2 and high pressured dichloromethane. 
